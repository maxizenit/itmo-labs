...
public class ReferencePersistentDao implements Dao<MemorySegment, Entry<MemorySegment>> {

    private final Comparator<MemorySegment> comparator = ReferencePersistentDao::compare;
    private final NavigableMap<MemorySegment, Entry<MemorySegment>> storage = new ConcurrentSkipListMap<>(comparator);
    private final Arena arena;
    private final MemorySegment readPage;
    private final Path path;

    public ReferencePersistentDao(Config config) throws IOException {
